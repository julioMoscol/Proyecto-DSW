...
CREATE TABLE tb_venta_producto_carrito (
  CodVentaPro int NOT NULL,
  IdEmpresaDelivery int NOT NULL,
  IdProducto INT NOT NULL,
  Fecha datetime DEFAULT NULL,
  ...
  IdPago int DEFAULT NULL,
  PRIMARY KEY (CodVentaPro),
  CONSTRAINT fk_vpidpagos FOREIGN KEY (IdPago) REFERENCES detalle_tipopago (iddetallepago),
  CONSTRAINT fk_vpidproducto FOREIGN KEY (IdProducto) REFERENCES producto (IdProducto),
  CONSTRAINT fk_vpidempresas FOREIGN KEY (IdEmpresaDelivery) REFERENCES empresa_delivery (IdEmpresaDelivery)
)
GO

create or alter proc agregar_venta_carrito_list
 
as
begin
  select *from tb_venta_producto_carrito
end
go

create or alter proc agregar_venta_carrito_add
    @CodVentaPro int,
    @IdEmpresaDelivery int,
    @IdProducto int,
    @Fecha  datetime,
...
as
begin
    insert into tb_venta_producto_carrito values (@CodVentaPro, @IdEmpresaDelivery, @IdProducto, @Fecha, @Direccion, @MontoTotal, @IdPago)
end
go

create or alter proc agregar_venta_carrito_update
    @CodVentaPro int,
    @IdEmpresaDelivery int,
    @IdProducto int,
    @Fecha  datetime,
...
as
begin
    update tb_venta_producto_carrito set CodVentaPro = @CodVentaPro, IdEmpresaDelivery = @IdEmpresaDelivery, IdProducto = @IdProducto, Direccion = @Direccion, Fecha = @Fecha, Direccion = @Direccion, MontoTotal = @MontoTotal, IdPago = @IdPago
    where CodVentaPro = @CodVentaPro
end
go
...
as
begin
    delete from tb_venta_producto_carrito
    where CodVentaPro = @CodVentaPro
end
go
---------------------------------
